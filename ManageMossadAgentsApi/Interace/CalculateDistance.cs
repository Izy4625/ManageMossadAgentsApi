...
namespace ManageMossadAgentsApi.Interace
{
    internal class CalculateDistance
    {
        ...
        public CalculateDistance(MossadDbContext context)
        {
            _context = context;
        }
        ...
        public  void HandleMissions(int agentsid, Location agentslocation)
        {
            ...
            {
                double amount = Calculate(target.Location, agentslocation);
        ...
        public double Calculate(Location agentslocation, Location targetlocation)
        {
